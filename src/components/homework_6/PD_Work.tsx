...
import Pdf from "../../assets/homework6/pd_work.pdf";
import Doc from "../../assets/homework6/zerebkovs_work.docx";
import {
  IconButton,
  Menu,
  MenuItem,
    ...
    <Box textAlign="center">
      ...
      >
        <Box sx={style}>
          <Grid container>
            <Grid item xs={11}>
              <h2 id="unstyled-modal-title">Praktiskais darbs</h2>
              <Button variant="contained" style={{ marginBottom: "1rem" }}>
                <a href={Doc} download style={{ textDecoration: "none" }}>
                  <Typography variant="h6">Lejupielādēt DOC failu</Typography>
                </a>
              </Button>
            </Grid>
            <Grid
